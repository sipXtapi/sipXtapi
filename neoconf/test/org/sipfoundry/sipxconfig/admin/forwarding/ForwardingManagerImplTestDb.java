...
/**
 * ForwardingManagerImplTestDb
 */
public class ForwardingManagerImplTestDb extends SipxDatabaseTestCase {
    private ForwardingManager m_context;
    private CoreManager m_coreContext;
    private Integer testUserId = new Integer(1000);

    protected void setUp() throws Exception {
        ApplicationContext appContext = TestHelper.getApplicationContext();
        m_coreContext = (CoreManager) appContext.getBean(CoreManager.CONTEXT_BEAN_NAME);
        m_context = (ForwardingManager) appContext.getBean(ForwardingManager.CONTEXT_BEAN_NAME);
