...
public class LoginManagerImplTest extends TestCase {
    private LoginManagerImpl m_impl;
    private User m_user;
    private static final Integer USER_ID = new Integer(314159);

    protected void setUp() throws Exception {
        m_impl = new LoginManagerImpl();
        ...
        MockControl control = MockControl.createNiceControl(CoreManager.class);
