...
public class CoreManagerImplTestDb extends SipxDatabaseTestCase {

    private static final int NUM_USERS = 10;
    private CoreManagerImpl m_core;

    protected void setUp() throws Exception {
        ApplicationContext app = TestHelper.getApplicationContext();
        m_core = (CoreManagerImpl) app.getBean(CoreManagerImpl.CONTEXT_BEAN_NAME);
