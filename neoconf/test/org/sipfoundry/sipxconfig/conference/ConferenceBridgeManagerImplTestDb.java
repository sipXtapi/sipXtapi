...
public class ConferenceBridgeManagerImplTestDb extends SipxDatabaseTestCase {

    private ConferenceBridgeManager m_context;
    private CoreManager m_coreContext;

    protected void setUp() throws Exception {
        m_context = (ConferenceBridgeManager) TestHelper.getApplicationContext().getBean(
                ConferenceBridgeManager.CONTEXT_BEAN_NAME);
        m_coreContext = (CoreManager) TestHelper.getApplicationContext().getBean(
