/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/ejb/src/com/pingtel/pds/pgs/patch/PatchManagerBean.java#4 $
 * 
...
public class PatchManagerBean extends JDBCAwareEJB implements SessionBean, PatchManagerBusiness {
    ...
    public Element getUpgradeInfo ()  {
        ...
        try {
            Document document =
                m_sax.build( getClass().getResourceAsStream( PATCH_XML_NAME ) );
            ...
            for ( Iterator iV = versions.iterator(); iV.hasNext(); ) {
                ...
                if ( versionNumber.intValue() <= targetVersion.intValue() ) {
                    ...
                    for ( Iterator iP = patches.iterator(); iP.hasNext(); ) {
                        ...
                        patchNumber =
                            new Integer ( patchElement.getAttributeValue( "number" ) );
                        ...
                        if (versionNumber.intValue() <= version.intValue()) {
                            ...
                            if ( status.equals("N") ) {
                                    ...
                                    String runStatus =
                                        runPatch ( className, args, patchNumber );

                                    logDebug ( "got status of " + runStatus + " for patch# " + patchNumber );
                    ...
                    if (    allPatchesApplied &&
                            versionNumber.intValue() > version.intValue() ) {
    ...
    private String runPatch ( String className, String args, Integer patchNumber )
        ...
        logDebug ( "about to run patch# " + patchNumber + " class " + className +
                    " args " + args );
    ...
    public Integer getDatabaseVersion () {
        ...
        try {
            ArrayList rows = executePreparedQuery ( "SELECT MAX(VERSION) " +
                                                    "FROM VERSIONS ",
                                                    null,
                                                    1,
                                                    1 );
    ...
    public void setDatabaseVersion ( Integer version) throws PDSException {
        ...
        try {
            ...
            executePreparedUpdate ( "INSERT INTO VERSIONS ( applied, version ) " +
                                    "VALUES ( ?, ? ) ",
                                    new Object [] { new java.sql.Date ( new java.util.Date().getTime() ), version } );
    ...
    public String getPatchStatus ( Integer patchNumber ) throws PDSException {
        ...
        try {
            ArrayList rows = executePreparedQuery ( "SELECT status " +
                                                    "FROM PATCHES " +
                                                    "WHERE patch_number = ?",
    ...
    public String getPatchDescription ( Integer patchNumber ) throws PDSException {
        ...
        try {
            ArrayList rows = executePreparedQuery ( "SELECT description " +
                                                    "FROM PATCHES " +
                                                    "WHERE patch_number = ?",
                                                    new Object [] { patchNumber },
                                                    1,
    ...
    private void setPatchStatus ( String status, Integer patchNumber, String description ) throws PDSException {
        ...
        try {
            ...
            executePreparedUpdate ( "  DELETE FROM PATCHES " +
                                    "   WHERE patch_number = ? ",
                                    new Object [] { patchNumber } ) ;

            executePreparedUpdate ( "  INSERT INTO PATCHES (    patch_number, date_applied, status, description )" +
                                    "  VALUES ( ?, ?, ?, ? )  ",
                                    new Object [] { patchNumber,
