/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/ejb/src/com/pingtel/pds/pgs/profile/propertysort/NumericAscending.java#4 $
 * 
...
public class NumericAscending extends PropertySorter {
   ...
   "</USER_LINE>";
    ...
    public static String id2 = "100";

    public static void main ( String args [] ) {

        NumericAscending sorter = new NumericAscending();
    ...
    public void addProperty ( Element property, String id ) {
        m_propertyMap.put( Integer.valueOf( id ), property );
    }

    public Collection getValues() {
        return this.m_propertyMap.values();
    }
}