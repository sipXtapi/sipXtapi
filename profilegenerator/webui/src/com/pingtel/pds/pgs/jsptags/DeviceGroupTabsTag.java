/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/DeviceGroupTabsTag.java#4 $
 * 
...
/**
 * DeviceGroupTabsTag builds the 'tabs' or buttons for the DeviceGroup
 * Details page.
 * @author ibutcher
 * 
 */
public class DeviceGroupTabsTag extends StyleTagSupport{
...
////
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            Element documentRootElement = mTagHanderHelperEJBObject.getDeviceGroupTabs(devicegroupid);
