/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/UnassignApplicationSetFromUserGroupTag.java#4 $
 * 
...
public class UnassignApplicationSetFromUserGroupTag extends ExTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            logger.debug( "doing unassign for usergroup: " +
                m_userGroupID + " app group: " + m_applicationGroupID );


            advocate.unassignUserGroupAndApplicationGroup(   m_userGroupID,
