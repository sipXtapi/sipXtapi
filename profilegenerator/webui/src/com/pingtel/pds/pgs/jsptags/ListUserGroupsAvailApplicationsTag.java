/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/ListUserGroupsAvailApplicationsTag.java#5 $
 * 
...
public class ListUserGroupsAvailApplicationsTag extends StyleTagSupport {
    ...
    public void setUsergroupid ( String usergroupid ) {
        this.m_userGroupID = usergroupid;
    }
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            Collection allAG = m_agHome.findByUserGroupID( Integer.valueOf( m_userGroupID ) );
            for ( Iterator iAll = allAG.iterator(); iAll.hasNext(); ) {
                ApplicationGroup ag = (ApplicationGroup) iAll.next();
                if ( ag.getName().startsWith( "ug" + m_userGroupID ) ) {
