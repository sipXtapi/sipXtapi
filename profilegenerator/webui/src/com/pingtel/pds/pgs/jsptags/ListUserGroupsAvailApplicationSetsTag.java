/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/ListUserGroupsAvailApplicationSetsTag.java#5 $
 * 
...
public class ListUserGroupsAvailApplicationSetsTag extends StyleTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            Collection existing =
                m_agHome.findByUserGroupID( Integer.valueOf( m_userGroupID ) );
