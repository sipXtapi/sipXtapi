/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/AssignApplicationSetToUserTag.java#4 $
 * 
...
public class AssignApplicationSetToUserTag extends ExTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            logger.debug( "doing assign for user: " +
                m_userID + " app group: " + m_applicationGroupID );

            advocate.assignUserAndApplicationGroup( m_userID,
