/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/AssignApplicationToApplicationGroupTag.java#4 $
 * 
...
public class AssignApplicationToApplicationGroupTag extends ExTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            logger.debug( "doing assign for application: " +
                m_applicationID + " app group: " + m_applicationGroupID );


            advocate.assignApplicationToApplicationGroup(   m_applicationID,
