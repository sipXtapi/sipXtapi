/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/UnassignApplicationFromUserTag.java#4 $
 * 
...
public class UnassignApplicationFromUserTag extends ExTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            logger.debug( "doing unassign for user: " + m_userID + " app: " + m_applicationID );

            advocate.uninstallApplicationFromUser( m_userID, m_applicationID );
