/*
 * $Id: //depot/OPENDEV/sipXconfig/profilegenerator/webui/src/com/pingtel/pds/pgs/jsptags/UnassignApplicationFromUserGroupTag.java#4 $
 * 
...
public class UnassignApplicationFromUserGroupTag extends ExTagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            logger.debug( "doing unassign for user group: " + m_userGroupID + " app: " + m_applicationID );
            advocate.uninstallApplicationFromUserGroup( m_userGroupID, m_applicationID );
