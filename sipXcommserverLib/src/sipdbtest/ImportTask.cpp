    ...
    const UtlString& rTableName ) const
{
    ...
    {
        // @JC Changed code to insert MD5 DIGESTED version of the
        // passtoken if the authType is set to NONE
        ...
        CredentialDB::getInstance()->
            insertRow ( uri, realm, userid, passtoken, "DIGEST" );
    ...
    } else if ( rTableName.compareTo("subscription" , UtlString::ignoreCase)==0 )
    {
        ...
        SubscriptionDB::getInstance()->
            insertRow(
                ...
                *((UtlString*)rNVPairs.findValue(&fileKey)),
