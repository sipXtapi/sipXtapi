...
set DEPD=C:\build\sipXdepends
set PATH=c:\Program Files\GnuWin32;%DEPD%\cppunit-1.10.2\lib;%DEPD%\pcre\bin;%DEPD%\openssl\out32.dbg;%DEPD%\libgsm\lib;%DEPD%\libspeex\lib;%PATH%
