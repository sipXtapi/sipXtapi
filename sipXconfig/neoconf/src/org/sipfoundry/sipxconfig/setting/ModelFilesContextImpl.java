...
public class ModelFilesContextImpl implements ModelFilesContext {
    ...
    static String globToPattern(String name) {
        ...
        String escapedPeriod = x; // surprisingly, esacaped period and period regexp is
                                    // identical strings
    ...
    /**
     * Order setting files from most specific last, or least sepecific first. Takes into account
     * hierarchy of "_" and wildcards (e.g. 79XXX is less specific than 7912)
     */
    ...
    /**
     * Strings with more details are more specific e.g. a_b (count = 1) is less specific then
     * x_y_z (count = 2) so return positive value
     */
    ...
    /**
     * Strings with wildcards furthest from the end of the string is the least specific e.g. axxxc
     * (distance of xxx from end = 4) is less specific than abxxx (distance of xxx from end = 3)
     * so return postive value
     */
