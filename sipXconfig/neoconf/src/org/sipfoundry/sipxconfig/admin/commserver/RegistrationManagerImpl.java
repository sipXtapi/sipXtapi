...
public class RegistrationManagerImpl implements RegistrationManager {
    public static final Log LOG = LogFactory.getLog(RegistrationManagerImpl.class);
    ...
    /**
     * @see org.sipfoundry.sipxconfig.admin.commserver.RegistrationManager#getRegistrations()
     */
