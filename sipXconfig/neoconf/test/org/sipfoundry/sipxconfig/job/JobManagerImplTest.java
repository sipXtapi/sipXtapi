...
public class JobManagerImplTest extends TestCase {

    public void testSchedule() {
        JobManager context = new JobManagerImpl();
    ...
    public void testFull() {
        ...
        for (int i = 0; i < JobManagerImpl.MAX_JOBS; i++) {
        ...
        assertEquals(JobManagerImpl.MAX_JOBS, context.getJobs().size());
