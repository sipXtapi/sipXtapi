...
public class LazySipxReplicationManagerImplTest extends TestCase {

    public void testGenerateAll() throws Exception {
        MockControl replicationCtrl = MockControl.createControl(SipxReplicationManager.class);
        SipxReplicationManager replication = (SipxReplicationManager) replicationCtrl.getMock();
        ...
        LazySipxReplicationManagerImpl lazy = new LazySipxReplicationManagerImpl();
