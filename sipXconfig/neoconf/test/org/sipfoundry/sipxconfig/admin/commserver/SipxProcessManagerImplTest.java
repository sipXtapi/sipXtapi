...
public class SipxProcessManagerImplTest extends TestCase {
    SipxProcessManagerImpl m_processContextImpl;

    protected void setUp() throws Exception {
        m_processContextImpl = new SipxProcessManagerImpl() {
            protected InputStream getStatusStream() {
                return SipxProcessManagerImplTest.class.getResourceAsStream("status.test.xml");
            }

            protected InputStream getTopologyAsStream() {
                return SipxProcessManagerImplTest.class.getResourceAsStream("topology.test.xml");
            }
        };
    }
    ...
    public void testConstructRestartUrl() {
        String[] url = m_processContextImpl.constructCommandUrls(
                SipxProcessManager.Process.REGISTRAR.getName(),
                SipxProcessManager.Command.RESTART);
    ...
    public void testConstructCommandUrls() throws Exception {
        ...
        final SipxProcessManager.Command COMMAND = SipxProcessManager.Command.START;
    ...
    // getStatusStream of SipxProcessManagerImpl for this purpose.
