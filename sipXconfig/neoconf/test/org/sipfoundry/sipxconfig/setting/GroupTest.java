...
public class GroupTest extends TestCase {
    ...
    public void testInherhitSettingsForEditingGetDefaultValue() {
        ...
        Group g = new Group();
        Setting settings = g.inherhitSettingsForEditing(bird);
        settings.getSetting("woodpecker/ivory-billed").setValue("2");
        
        assertEquals("0", settings.getSetting("woodpecker/ivory-billed").getDefaultValue());
        assertEquals("2", settings.getSetting("woodpecker/ivory-billed").getValue());
    }
}
