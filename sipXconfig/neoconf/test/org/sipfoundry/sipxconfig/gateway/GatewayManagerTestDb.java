...
public class GatewayManagerTestDb extends SipxDatabaseTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        m_context = (GatewayManager) m_appContext.getBean(GatewayManager.CONTEXT_BEAN_NAME);
        m_dialPlanContext = (DialPlanManager) m_appContext
                .getBean(DialPlanManager.CONTEXT_BEAN_NAME);
