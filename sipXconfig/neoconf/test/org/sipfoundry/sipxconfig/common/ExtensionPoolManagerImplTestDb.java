...
public class ExtensionPoolManagerImplTestDb extends SipxDatabaseTestCase {
    private ExtensionPoolManager m_context;

    protected void setUp() throws Exception {
        ApplicationContext app = TestHelper.getApplicationContext(); 
        m_context = (ExtensionPoolManager) app.getBean(ExtensionPoolManager.CONTEXT_BEAN_NAME);
