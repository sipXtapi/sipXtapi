...
function reloadFrameSet(src) {
    ...
    if ( selectedIndex != -1 )
    {
        ...
        top.mainFrame.location = "user_frameset.jsp?" + mfgDeviceToLoad;
    }
    else
    {
...
<body class="bglight" onLoad="MM_goToURL('top.frames[\'command\']','../command/details_user_cmd.html')">

<pgs:userTabs stylesheet='<%=request.getParameter("stylesheet")%>' outputxml="false"
