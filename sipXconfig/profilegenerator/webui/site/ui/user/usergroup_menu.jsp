...
function reloadFrameSet(src) {
    ...
    if ( selectedIndex != -1 )
    {
        ...
        top.mainFrame.location = "usergroup_frameset.jsp?" + mfgDeviceToLoad;
    }
    else
    {
...
<body class="bglight" onLoad="MM_goToURL('top.frames[\'command\']','../command/details_usergroup_cmd.html')">

<pgs:userGroupTabs stylesheet='<%=request.getParameter("stylesheet")%>' outputxml="false"
