...
<head>
    ...
    <table cellspacing="1" cellpadding="4" border="0" width="600" class="bglist">
        ...
        <tr>
            <td width="450">Dial Plan Mapping Rules</td>
            <td align="center"><a onFocus="if(this.blur)this.blur()" onMouseOver="MM_swapImage('sm_btn_delstart','','../buttons/sm_btn_f2.gif',1)" onMouseOut="MM_swapImgRestore()" href="/pds/commserver/mappingrules_details.jsp">
                <img border="0" height="17" width="23" src="../buttons/sm_btn.gif" name="sm_btn_delstart"/></a></td>
        </tr>
        <tr>
