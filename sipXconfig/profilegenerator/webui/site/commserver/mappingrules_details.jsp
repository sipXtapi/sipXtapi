...
<%
	...
	if (xml.isValid())
	    ...
	    try
            {
	        xml.save(ProcessDestinationsBean.getMappingRulesFilename());
    ...
    {
        xml.load(ProcessDestinationsBean.getMappingRulesFilename());
    }
%>
<html>
<head>
...
<table width="600">
    <tr>
        <td width="50%" align="left">
            <h1 class="list">Dial Plan Mapping Rules</h1>
        </td>
...
<form name="inputform" action="mappingrules_details.jsp" method="post">
<input type="submit" name="action" value="Save">
<input type="submit" name="action" value="Reload"><br/>
<textarea name="content" rows="35" cols="90" wrap="soft"><%= xml.getContent() %></textarea>
</form>
</body>
</html>