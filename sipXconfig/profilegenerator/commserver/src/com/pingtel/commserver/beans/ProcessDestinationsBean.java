...
public abstract class ProcessDestinationsBean {
    ...
    // mappingrules.xml
    private static final String MAPPING_RULES_XML = PathLocatorUtility.
    	getPath( PathLocatorUtility.XML_FOLDER ) + "mappingrules.xml.in";
    
    // fallbackrules.xml (previously mappingrules2.xml)
    ...
    public static String getMappingRulesFilename()
    {
        return MAPPING_RULES_XML;
    }
