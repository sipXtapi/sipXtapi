 ...
 *  MODIFIED the method 
    ...
    BY PRADEEP PAUDYAL TO not include new lines when encoding.
 
   ADDED a new method 
   public static String encodeBytesFormatted( byte[] source, int off, int len )
   which is a copy of the old method encodeBytes.
 *
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static String encodeBytesFormatted( byte[] source )
    {   return encodeBytesFormatted( source, 0, source.length );
    }
     ...
     * @since 1.4
     * MODIFIED BY PRADEEP PAUDYAL TO not include new lines when encoding.
     * This may brak decoding if decoding is expecting new line at MAX_LINE_LENGTH.
     */
    public static String encodeBytes( byte[] source, int off, int len )
    {
        int    len43   = len * 4 / 3;
     ...
     * @since 1.3
     */
    public static String encodeStringFormatted( String s )
    {   return encodeBytesFormatted( s.getBytes() );
    }   // end encodeString
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
        ...
        /**
         * Constructs a {@link com.pingtel.pds.pgs.sipxchange.replication.Base64.InputStream} in DECODE mode.
         *
        ...
        /**
         * Constructs a {@link com.pingtel.pds.pgs.sipxchange.replication.Base64.InputStream} in
    ...
    /**
     * A {@link com.pingtel.pds.pgs.sipxchange.replication.Base64.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        /**
         * Constructs a {@link com.pingtel.pds.pgs.sipxchange.replication.Base64.OutputStream} in ENCODE mode.
         *
        ...
        /**
         * Constructs a {@link com.pingtel.pds.pgs.sipxchange.replication.Base64.OutputStream} in
         * either ENCODE or DECODE mode.
         *
         * @param out the {@link java.io.OutputStream} to which data will be written.
         * @param encode Conversion direction
