...
/**
 * DataSetBuilderBusiness is the Business Interface (pattern) for the DataSetBuilder EJ Bean. It
 * is used to create the XML databases which get sent to the various servers in a sipxchange
 * installation.
 */
public interface DataSetBuilderBusiness {
     ...
     * 
     * @throws com.pingtel.pds.common.PDSException is thrown for application (non-critical)
     *         errors.
