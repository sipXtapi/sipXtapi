 ...
 * read data and places the internal stun packet on a MsgQ for latter 
 * processing.
 */
...
/* ============================ MANIPULATORS ============================== */
    ...
    /**
     * Get a STUN packet from the internal message queue.  This is used when
     * someone else is pumping the inbound traffic.
     *
     ...
     */
    virtual int getStunPacket(char* buffer, int bufferLength, const OsTime& rTimeout) ;
...
//: OsStunRefreshEvent is a helper class that implements a stun binding check
...
/* //////////////////////////// PRIVATE /////////////////////////////////// */
private:
    OsStunDatagramSocket* mpSocket ;  /**< Socket to perform stun operation */
