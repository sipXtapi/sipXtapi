...
/* ============================ INQUIRY =================================== */
   static OsStatus getDeviceToken(UtlString &rTokenValue);
    //:Returns a unique identifier for this device. Odds are, no other device
    //:will have this same id.  (1 out of 1.9406476153758861689362243605781e+230)
