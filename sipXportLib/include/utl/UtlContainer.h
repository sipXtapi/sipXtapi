...
protected:
    ...
    /**<
     * This must be called by any code that will take both the mContainerRefLock in
     * an iterator and the mContainerLock in a container.  It can be released as soon
     * as both those locks are acquired, and should be, since most operations on any
     * iterator will need to take it briefly.
     */
