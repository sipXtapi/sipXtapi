 ...
 * It disconnects the iterator from its container object (sets mpMyContainer to NULL).
 *
...
{
   // The caller is holding the sIteratorConnectionLock, so it is OK to lock this.
