...
class TestUtilities
{
 public:
    ...
    *
    *   @param num Number of char* messages that have been passed as arguments
    *   @param outMsg string instance into which the generated message is written to. It is
    *   the responsibility of the caller to create the string
    *   @param variable list arguments of char* which represents the fragments of 
    *   the message
    ...
    */
    static void createMessage(int , std::string* , ...) ;
