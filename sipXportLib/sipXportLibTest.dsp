...
# ADD CPP /nologo /MD /W3 /GX /O1 /I "." /I "include" /I "src/test" /I "..\CPPUnit\include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D TEST_DIR=\".\" /YX /FD /c
...
# ADD LINK32 cppunit.lib sipXportLib.lib libpcre.a wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386 /libpath:"Release" /libpath:"..\CPPUnit\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "." /I "include" /I "src/test" /I "..\CPPUnit\include" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D TEST_DIR=\".\" /FR /YX /FD /GZ /c
...
# ADD LINK32 cppunitd.lib sipXportLibd.lib pcre.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"debug" /libpath:"..\CPPUnit\lib"
