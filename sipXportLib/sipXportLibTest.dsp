...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "." /I "include" /I "src/test" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "DISABLE_MEM_POOLS" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "." /I "include" /I "src/test" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "DISABLE_MEM_POOLS" /D "DONT_USE_LONG_LONG" /FR /YX /FD /GZ /c
...
# ADD LINK32 cppunitd_dll.lib sipXportLibd.lib libpcre.a wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"debug"
