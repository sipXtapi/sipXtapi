...
public:
    ...
    virtual void OnKeepaliveStart(OsNatKeepaliveEvent& event) 
    {
    ...
    virtual void OnKeepaliveStop(OsNatKeepaliveEvent& event) 
    {
    ...
    virtual void OnKeepaliveFeedback(OsNatKeepaliveEvent& event) 
    {
    ...
    virtual void OnKeepaliveFailure(OsNatKeepaliveEvent& event) 
    {
