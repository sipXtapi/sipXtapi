...
#define SIPXTAPI_BUILDNUMBER "7424"             /**< Default build number -- automatically filled in 
                                                  during release process*/
#define SIPXTAPI_BUILD_WORD 2,9,1,7424          /**< Default build word -- automatically filled in 
                                                  during release process */
#define SIPXTAPI_FULL_VERSION "2.9.1.7424"      /**< Default full version number -- automatically filled in 
                                                  during release process*/
#define SIPXTAPI_BUILDDATE "2006-09-06"      /**< Default build date -- automatically filled in 
                                                  during release process*/
