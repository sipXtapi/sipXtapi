...
#define SIP_REQUEST_NOT_ACCEPTED_HERE 488
#define SIP_REQUEST_NOT_ACCEPTED_URL_TYPE_TEXT "Url Type Not Supported"
...
/* ============================ INQUIRY =================================== */
    ...
    UtlBoolean isAckFor(SipMessage* inviteResponse) const;
    //SDUA
    UtlBoolean isInviteFor(SipMessage* inviteRequest) const;
