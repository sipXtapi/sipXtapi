    ...
    else
    {
       ...
       if (0 == method.compareTo(SIP_INVITE_METHOD))
       {
          ...
          if (header)
          {
             ...
             requestUri.toString(uriWithoutHeaderParams);
...
#               endif
            ...
            {
               // TODO: Someone need to investigate this because it shows 
               // up a lot in the logging. So for now, the logging level is
               // being put on DEBUG.
                OsSysLog::add(FAC_SIP, PRI_DEBUG,
                    "ERROR!!! SipTransaction::handleChildIncoming %d response with parent client transaction NOT dispatched",
                    responseCode);
            }
        }
        else
                    ...
                    if(findBestResponse(bestResponse))
                    {
                        ...
                        if (OsSysLog::willLog(FAC_SIP, PRI_DEBUG))
                        {
                           ...
                           OsSysLog::add(FAC_SIP, PRI_DEBUG,
                                         ...
                                         "SipTransaction::handleChildIncoming: response %d for \r\nCall-Id: %s\r\n",
