	                ...
	                while ((nv = (NameValuePair*) iterator()))
	                {
                        ...
                        else if(mpDetailedMessageWaitingFunction)
                        {
                                ...
                                numberString.data()[0] == '-')
                            {
                                ...
                                // Should "int" be removed?  Should this be " = 0;"?
                                int newMessages = -1;  // Cut'n'paste error?
                                // or, is this irrelevant?  (it gets reassigned,
                                // below, since we would not get here unless
                                // numberString is not null.
