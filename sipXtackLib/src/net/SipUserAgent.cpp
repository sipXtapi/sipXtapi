                            ...
                            void* responseListenerData)
{
   ...
   if(transaction == NULL)
   {
      ...
      else
      {
         ...
         {
            // TODO: Someone needs to investigate this because we get a lot
            // of this message in the logging file. For now, the logging
            // level is reduced to DEBUG.
            OsSysLog::add(FAC_SIP, PRI_DEBUG,
                          "WARNING!!! SipUserAgent::send proxied client transaction does not have parent\n");
         }
             ...
             )
         {
            ...
            if (! message->isResponse()) // events apply only to requests
            {
               ...
               if (useEventFilter)
               {
                  ...
                  matchedEvent = (   (   method.compareTo(SIP_SUBSCRIBE_METHOD,UtlString::ignoreCase) == 0
                                      || method.compareTo(SIP_NOTIFY_METHOD,UtlString::ignoreCase) == 0
                                      )
                              ...
                              int& port)
{
    ...
    else
    {
        ...
        {
            OsSysLog::add(FAC_SIP, PRI_DEBUG,
                "SipUserAgent::getViaInfo unknown protocol: %d", protocol);
        }
