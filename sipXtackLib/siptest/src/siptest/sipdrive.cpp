...
int main(int argc, char* argv[])
{
    ...
    configDb.get("SIP_TEST_UDP_PORT", proxyUdpPort);
    if(proxyUdpPort <=0) proxyUdpPort = 3000;

    configDb.get("SIP_TEST_TCP_PORT", proxyTcpPort);
    if(proxyTcpPort <=0) proxyTcpPort = 3000;
