...
IF NOT "%SIPX_MSVC_BASE%" == "" GOTO SET_MSVC_VARS
SET SIPX_MSVC_BASE=C:\Program Files\Microsoft Visual Studio .NET 2003\VC7

:SET_MSVC_VARS
ECHO.
ECHO ****************************************
ECHO Calling MSVC71 VCVARS32.bat
ECHO ****************************************
call "%SIPX_MSVC_BASE%\bin\VCVARS32.bat"

:BUILD_PROJECTS
call _build_msvc71 %1
