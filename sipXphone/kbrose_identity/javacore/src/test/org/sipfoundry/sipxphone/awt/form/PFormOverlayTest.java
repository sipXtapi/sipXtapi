 ...
 */
public class PFormOverlayTest extends TestCase
{
    public void setUp()
    {
    }
    ...
    public void testInitialize()
    {
        try
        {
        	PFormOverlay overlay = new PFormOverlay();
        	overlay.initialize();
        	...
        	java.awt.event.MouseEvent e  =
        		new java.awt.event.MouseEvent(new TextArea(), 0, 0, 0, 158, 120, 1, false);
        	
        	assertEquals(overlay.invokeButton(e), PButtonEvent.BID_R4);
