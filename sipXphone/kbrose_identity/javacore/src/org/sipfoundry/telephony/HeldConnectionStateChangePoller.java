/*
 * $Id: //depot/OPENDEV/sipXphone/javacore/src/org.sipfoundry/telephony/HeldConnectionStateChangePoller.java#2 $
 *
 ...
 */
public class HeldConnectionStateChangePoller extends AbstractStateChangePoller
...
////
     ...
     * call object, address, and optional session.
     */
    public HeldConnectionStateChangePoller(PtCall call, PAddress address, PSession session)
    {
        super() ;
