/*
 * $Id: //depot/OPENDEV/sipXphone/javacore/src/org.sipfoundry/xpressa/app/preferences/CallForwardingFeatureIndicator.java#2 $
 *
...
/**
 * The CallForwardingFeatureIndicator is displayed when the user enables
 * the Forward All Calls feature of the phone.  This indicator servers as a
 * visual reminder to the user.  They can also press the button next to the
 * button as a shortcut to disable call forwarding.
 */
public class CallForwardingFeatureIndicator implements FeatureIndicator
{
//////////////////////////////////////////////////////////////////////////////
// Attributes
////
    ...
    private static CallForwardingFeatureIndicator m_instance = null ;
...
////
     ...
     */
    private CallForwardingFeatureIndicator()
    {
...
////
     ...
     */
    public static CallForwardingFeatureIndicator getInstance()
    {
        if (m_instance == null)
        {
            m_instance = new CallForwardingFeatureIndicator() ;
        }
    ...
    {
        CallHandlingManager manager = Shell.getCallHandlingManager() ;
        return manager.isForwardingAllEnabled() ;
    }
    ...
    {
        return AppResourceManager.getInstance().getImage("imgCallForward") ;
    }


    public String getShortDescription()
    {
        return AppResourceManager.getInstance().getString("lblCallForwardingFIDesc") ;
    }
    ...
    {
        return AppResourceManager.getInstance().getString("lblCallForwardingFIHint") ;
    }
    ...
    {
        return new icIconTextContainer(getIcon(), AppResourceManager.getInstance().getString("lblCallForwardingFIDesc")) ;
    }
    ...
    public void buttonPressed()
    {
        ...
        msgBox.setMessage(AppResourceManager.getInstance().getString("lblCallForwardingFIPrompt")) ;
        if (msgBox.showModal() == MessageBox.OK)
        {
            CallHandlingManager manager = Shell.getCallHandlingManager() ;
            manager.setPhonesetForwardingAll(false) ;
            uninstall() ;
        }
    }
