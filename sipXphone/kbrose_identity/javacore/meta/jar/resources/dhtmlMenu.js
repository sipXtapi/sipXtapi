...
//see accompanying "config.htm" file for more information on structure of menus
    ...
    if (( document.forms["menu_controller"]) &&
        ...
        Menu4=new Array("Administration","",7,24,100);
    	...
    	Menu4_6=new Array("Upgrade Log",ip+"/cgi/upgradelog.cgi",0,22,140);
    	Menu4_7=new Array("File Listing",ip+"/cgi/filelist.cgi",0,22,140);
        ...
        Menu5=new Array("Administration","",7,24,100);
    	...
    	Menu5_6=new Array("Upgrade Log",ip+"/cgi/upgradelog.cgi",0,22,140);
    	Menu5_7=new Array("File Listing",ip+"/cgi/filelist.cgi",0,22,140);
