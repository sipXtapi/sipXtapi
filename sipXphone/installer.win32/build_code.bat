...
call _build_cpp_project sipXphone %1
IF NOT "%ERRORLEVEL%"=="0" GOTO ERROR_EXIT
call _build_java_subproject sipXphone javacore
IF NOT "%ERRORLEVEL%"=="0" GOTO ERROR_EXIT
call _build_java_subproject sipXphone softphone
IF NOT "%ERRORLEVEL%"=="0" GOTO ERROR_EXIT
...
echo Setting build.err in err.prf
popd .
ECHO .
