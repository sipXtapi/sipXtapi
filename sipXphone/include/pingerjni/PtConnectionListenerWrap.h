// $Id: //depot/OPENDEV/sipXphone/include/pingerjni/PtConnectionListenerWrap.h#2 $
// 
...
#ifndef _PtConnectionListenerWrap_h_
#define _PtConnectionListenerWrap_h_
...
class PtConnectionListenerWrap : public PtConnectionListener
{
/* //////////////////////////// PUBLIC //////////////////////////////////// */
public:
...
/* ============================ CREATORS ================================== */
   ...
   PtConnectionListenerWrap(PtEventMask* pMask = NULL, long lHashID = 0, jobject jobjListener = NULL, unsigned long ulExcludeMask=0) ;
     //:Default constructor
...
protected:
   ...
   PtConnectionListenerWrap(const PtConnectionListenerWrap& callListenerWrap);
     //:Copy constructor
...
#endif  // _PtConnectionListenerWrap_h_
