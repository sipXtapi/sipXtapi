...
BEGIN_EVENT_TABLE(ContactListPanel, wxPanel)
   EVT_BUTTON(IDR_ADD_PARTY_BUTTON, OnAddContact)
   EVT_BUTTON(IDR_REMOVE_PARTY_BUTTON, OnRemoveContact)
   EVT_LIST_ITEM_ACTIVATED(IDR_CONFERENCE_LIST, OnSelectContact)
END_EVENT_TABLE()
