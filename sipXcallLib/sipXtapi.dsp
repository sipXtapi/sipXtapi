...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "include" /I "..\sipXportLib\include" /I "..\sipXportLib\include\glib" /I "..\sipXtackLib\include" /I "..\sipXmediaLib\include" /I "..\gips" /I "..\gips\sipXmediaVoiceEngine\include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SIPXTAPI_EXPORTS" /D "DISABLE_MEM_POOLS" /D "HAVE_GIPS" /D "VOICE_ENGINE" /FR /YX /FD /c
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib wsock32.lib sipXportLib.lib sipXtackLib.lib sipXmediaVoiceEngine.lib sipXcallLib.lib libpcre.a VideoEngineWindowsLib.lib /nologo /dll /map /debug /machine:I386 /libpath:"..\sipXcallLib\Release" /libpath:"..\sipXmediaLib\release" /libpath:"..\sipXportLib\release" /libpath:"..\sipXtackLib\Release" /libpath:"..\gips\sipXmediaVoiceEngine\Release" /libpath:"..\gips\VoiceEngine\libraries"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "..\sipXportLib\include" /I "..\sipXcallLib\include" /I "include" /I "..\sipXportLib\include\glib" /I "..\sipXtackLib\include" /I "..\sipXmediaLib\include" /I "..\gips" /I "..\gips\sipXmediaVoiceEngine\include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SIPXTAPI_EXPORTS" /D "DISABLE_MEM_POOLS" /D "HAVE_GIPS" /D "VOICE_ENGINE" /YX /FD /GZ /c
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib wsock32.lib sipXportLib.lib sipXtackLib.lib sipXmediaLib.lib sipXcallLib.lib libpcre.a GIPS_win.lib /nologo /dll /map /debug /machine:I386 /out:".\sipXtapi\Debug_NoVE/sipXtapid.dll" /pdbtype:sept /libpath:"..\sipXcallLib\Debug_NoVE" /libpath:"..\sipXmediaLib\Debug" /libpath:"..\sipXportLib\debug" /libpath:"..\sipXtackLib\Debug" /libpath:"..\gips"
