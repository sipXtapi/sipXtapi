...
/* ============================ CREATORS ================================== */
   ...
   CpPhoneMediaInterface(int startRtpPort = 8766, int lastRtpPort = 8800,
                         const char* publicAddress = NULL, const char* localAddress = NULL,
                         int numCodecs = 0, SdpCodec* sdpCodecArray[] = NULL,
                         const char* pLocale = "",
