...
/* ============================ MANIPULATORS ============================== */
    ...
    *
    * @param localPort The desired local port or 0 to auto-select.
    */ 
   virtual OsStatus createConnection(int& connectionId, int localPort = 0) = 0 ;
   ...
   virtual OsStatus getCapabilities(int connectionId, 
                                    ...
                                    int& rtpPort,
                                    int& rtcpPort,
                                    SdpCodecFactory& supportedCodecs) = 0;
