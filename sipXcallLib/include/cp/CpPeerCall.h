...
protected:
    ...
    //: message
        ...
        UtlBoolean handleConsultTransfer(OsMsg* pEventMessage);
...
private:
    ...
    CONTACT_TYPE meContactType ;    // Default contact type

#ifndef SIPXTAPI_EXCLUDE
    SIPX_CALLSTATE_MAJOR eLastMajor ;
    SIPX_CALLSTATE_MINOR eLastMinor ;
#endif
