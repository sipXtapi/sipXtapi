...
typedef enum SIPX_CALLSTATE_MAJOR
{
    ...
    NEWCALL                 = 1000, /**< The NEWCALL event indicates that a new call has been
        ...
        DTMF_DOWN       = 9000,  /**< A DTMF button down event has been received from the
                                 remote party of the indicated call.  The minor event 
                                 indicates which button has been pressed. */
        DTMF_UP         = 9500,  /**< A DTMF button up event has been received from the
                                 remote party of the indicated call.  The minor event 
...
typedef enum SIPX_CALLSTATE_MINOR
{
    ...
    DTMF_0                      = DTMF_DOWN + '0',        /**< 0 key in DTMF_DOWN or DTMF_UP event */
    DTMF_1                      = DTMF_DOWN + '1',        /**< 1 key in DTMF_DOWN or DTMF_UP event */
    DTMF_2                      = DTMF_DOWN + '2',        /**< 2 key in DTMF_DOWN or DTMF_UP event */
    DTMF_3                      = DTMF_DOWN + '3',        /**< 3 key in DTMF_DOWN or DTMF_UP event */
    DTMF_4                      = DTMF_DOWN + '4',        /**< 4 key in DTMF_DOWN or DTMF_UP event */
    DTMF_5                      = DTMF_DOWN + '5',        /**< 5 key in DTMF_DOWN or DTMF_UP event */
    DTMF_6                      = DTMF_DOWN + '6',        /**< 6 key in DTMF_DOWN or DTMF_UP event */
    DTMF_7                      = DTMF_DOWN + '7',        /**< 7 key in DTMF_DOWN or DTMF_UP event */
    DTMF_8                      = DTMF_DOWN + '8',        /**< 8 key in DTMF_DOWN or DTMF_UP event */
    DTMF_9                      = DTMF_DOWN + '9',        /**< 9 key in DTMF_DOWN or DTMF_UP event */
    DTMF_STAR                   = DTMF_DOWN + '*',        /**< * key in DTMF_DOWN or DTMF_UP event */
    DTMF_POUND                  = DTMF_DOWN + '#',        /**< #  key in DTMF_DOWN or DTMF_UP event */
 ...
 * @param nLength length of string buffer szBuffer
 */
