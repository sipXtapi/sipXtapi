...
void Connection::fireSipXEvent(SIPX_CALLSTATE_MAJOR eMajor, SIPX_CALLSTATE_MINOR eMinor) 
{
            ...
            validStateTransition(m_eLastMajor, eMajor))
    {
        ...
        sipxFireEvent(mpCallManager, callId.data(), &session, remoteAddress.data(), eMajor, eMinor) ;
        ...
        if (eMajor == DISCONNECTED)
        {
            ...
            {
                sipxFireEvent(mpCallManager, callId.data(), &session, remoteAddress.data(), DESTROYED, DESTROYED_NORMAL) ;
