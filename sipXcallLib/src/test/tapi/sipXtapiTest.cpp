...
{
    m_events[m_numEvents++] = sipxEventToString(eMajor, eMinor) ;
}

void EventRecorder::addCompareEvent(SIPX_CALLSTATE_MAJOR eMajor, SIPX_CALLSTATE_MINOR eMinor) 
{
    m_compareEvents[m_numCompareEvents++] = sipxEventToString(eMajor, eMinor) ;
}

void EventRecorder::addEvent(SIPX_LINE_EVENT_TYPE_MAJOR eMajor) 
{
    m_events[m_numEvents++] = sipxLineEventToString(eMajor);
}

void EventRecorder::addCompareEvent(SIPX_LINE_EVENT_TYPE_MAJOR eMajor)
{
    m_compareEvents[m_numCompareEvents++] = sipxLineEventToString(eMajor);
}
...
void sipXtapiTestSuite::testLineAPI_Add() 
{
	...
	// Add Line
	CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, "sip:bandreasen@pingtel.com", true, &hLine), SIPX_RESULT_SUCCESS) ;	
	CPPUNIT_ASSERT(hLine) ;

	// Re-Add Line
	CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, "sip:bandreasen@pingtel.com", true, &hLine2), SIPX_RESULT_FAILURE) ;
...
void sipXtapiTestSuite::testLineAPI_Remove() 
{
	...
	CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, "sip:removeme@pingtel.com", true, &hLine), SIPX_RESULT_SUCCESS) ;	
	CPPUNIT_ASSERT(hLine) ;
...
void sipXtapiTestSuite::testLineAPI_Credential() 
{
	...
	// Add a line to remove
	CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, "sip:credential@pingtel.com", true, &hLine), SIPX_RESULT_SUCCESS) ;
	CPPUNIT_ASSERT(hLine) ;
...
void sipXtapiTestSuite::testLineAPI_Get() 
{
	...
	CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, szURI, true, &hLine), SIPX_RESULT_SUCCESS) ;	
	CPPUNIT_ASSERT(hLine) ;
