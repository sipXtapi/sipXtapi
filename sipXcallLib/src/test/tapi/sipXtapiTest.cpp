...
void sipXtapiTestSuite::testConfBasic1()
{
    ...
    CPPUNIT_ASSERT_EQUAL(sipxLineAdd(g_hInst, "sip:foobar@127.0.0.1:8000", &hLine), SIPX_RESULT_SUCCESS) ;
...
void sipXtapiTestSuite::testLineEvents()
{
    ...
    g_lineRecorder.addCompareEvent(SIPX_LINE_EVENT_PROVISIONED);
