...
sed -i "s/SIPXTAPI_BUILD_WORD [0-9,,]*/SIPXTAPI_BUILD_WORD 2,10,1,%REPRO_VERSION%/g" ..\..\include\tapi\sipXtapi.h
sed -i "s/SIPXTAPI_FULL_VERSION.*\".*\"/SIPXTAPI_FULL_VERSION \"2.10.1.%REPRO_VERSION%\"/g" ..\..\include\tapi\sipXtapi.h
