...
UtlBoolean SipRegistrar::handleMessage( OsMsg& eventMessage )
{
    ...
    //osPrintf("SipRegistrar::handleMessage() :: Start processing SIP message\n");
    ...
    const char* configFileName )
{
    ...
    {
        configDb.set("SIP_REGISTRAR_UDP_PORT", "");
        configDb.set("SIP_REGISTRAR_TCP_PORT", "");
    ...
    configDb.get("SIP_REGISTRAR_UDP_PORT", udpPort);
    configDb.get("SIP_REGISTRAR_TCP_PORT", tcpPort);
    ...
    {
        defaultMaxExpiresTime.append("7200"); //defult to 2 hrs
    }
    ...
    SipRegisterHooks* sipRegisterHooks = new SipRegisterHooks();
