    ...
    implements InvocationHandler
{
    ...
    public void testNop() {
        // here only until DISABLED_testLoadJar is activated
    }

    /**
     * Can we load a application jar
     *
     * Temporarily disabled until there's a new dummy phone application
     */
    public void DISABLED_testLoadJar()
    {
        try
        {
            ...
            Class c = loader.loadClass("com.pingtel.xpressa.apps.phonebook.Phonebook");
