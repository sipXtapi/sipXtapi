...
static const char codecMIMEsubtype[] = "g726-40";

static const struct plgCodecInfoV1 sipxCodecInfog726_40 = 
{
...
CODEC_API int PLG_ENUM_V1(g726_40)(const char** mimeSubtype, unsigned int* pModesCount, const char*** modes)
{
   if (mimeSubtype) {
...
CODEC_API void *PLG_INIT_V1(g726_40)(const char* fmtps, int isDecoder, struct plgCodecInfoV1* pCodecInfo)
{
   if (pCodecInfo == NULL) {
      return NULL;
   }
   memcpy(pCodecInfo, &sipxCodecInfog726_40, sizeof(struct plgCodecInfoV1));
   
   return g726_init(NULL, 40000, G726_ENCODING_LINEAR, G726_PACKING_NONE);
}
