...
static const char codecMIMEsubtype[] = "pcma";

static const struct plgCodecInfoV1 sipxCodecInfoPCMA = 
{
...
CODEC_API void *PLG_INIT_V1(sipxPcma)(const char* fmtps, int isDecoder, struct plgCodecInfoV1* pCodecInfo)
{
   if (pCodecInfo == NULL) {
      return NULL;
   }
