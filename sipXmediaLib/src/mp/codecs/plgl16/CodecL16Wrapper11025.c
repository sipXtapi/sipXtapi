...
static const struct MppCodecInfoV1_1 sgCodecInfo_11025 = 
{
...
CODEC_API int PLG_GET_INFO_V1_1(sipxL16_11025)(const struct MppCodecInfoV1_1 **codecInfo)
{
   if (codecInfo)
   {
      *codecInfo = &sgCodecInfo_11025;
   }
   return RPLG_SUCCESS;
}
                                             ...
                                             struct MppCodecFmtpInfoV1_2* pCodecInfo)
{
   ...
   pCodecInfo->minBitrate = 11025*16;
   pCodecInfo->maxBitrate = 11025*16;
...
CODEC_API int PLG_FREE_V1(sipxL16_11025)(void* handle, int isDecoder)
{
   return RPLG_SUCCESS;
}

CODEC_API int PLG_DECODE_V1(sipxL16_11025)(void* handle, const void* pCodedData, 
...
CODEC_API int PLG_ENCODE_V1(sipxL16_11025)(void* handle, const void* pAudioBuffer, 
