...
static const struct MppCodecInfoV1_1 sgCodecInfo_48000 = 
{
...
CODEC_API int PLG_GET_INFO_V1_1(sipxL16_48000)(const struct MppCodecInfoV1_1 **codecInfo)
{
   if (codecInfo)
   {
      *codecInfo = &sgCodecInfo_48000;
   }
   return RPLG_SUCCESS;
}


CODEC_API void *PLG_INIT_V1_2(sipxL16_48000)(const char* fmtp, int isDecoder,
                                             struct MppCodecFmtpInfoV1_2* pCodecInfo)
{
   ...
   pCodecInfo->minBitrate = 48000*16;
   pCodecInfo->maxBitrate = 48000*16;
...
CODEC_API int PLG_FREE_V1(sipxL16_48000)(void* handle, int isDecoder)
{
   return RPLG_SUCCESS;
}

CODEC_API int PLG_DECODE_V1(sipxL16_48000)(void* handle, const void* pCodedData, 
...
CODEC_API int PLG_ENCODE_V1(sipxL16_48000)(void* handle, const void* pAudioBuffer, 
