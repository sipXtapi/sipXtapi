...
#define EXTRA_MIC_DELAY 224      // Probably, this would be 0 in the real-time product
...
static int DelayedMic[TWOM + EXTRA_MIC_DELAY];
static int DelayedLdspkr[TWOM + EXTRA_LDSPKR_DELAY];
...
/* DEBUG!!!!This is only for monitoring time domain ERL.
   This can be eliminated in final release. */
    static short micdl[5*M+TWOM+EXTRA_MIC_DELAY];  // For monitoring time domain ERL
...
// for DEBUG!!!!! only monitoring of ERL
    ...
    {    // print out ERL every 1s
       ...
       osPrintf("ERL:%3d  ",Temp0/50);  //ERL printout for VxWorks
