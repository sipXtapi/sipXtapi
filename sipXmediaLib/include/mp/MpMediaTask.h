...
#ifdef _PROFILE /* [ */
   unsigned long long mStartTicks;   // Start time (in microseconds) for the current frame 
                            //  processing interval
   unsigned long long mStopTicks;    // Stop time (in microseconds) for the current frame
                            //  processing interval
   unsigned long long mLimitTicks;   // Frame processing time limit (in nanoseconds)
#endif /* _PROFILE ] */
