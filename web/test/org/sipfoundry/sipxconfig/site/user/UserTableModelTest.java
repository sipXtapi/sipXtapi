...
public class UserTableModelTest extends TestCase {
    ...
    public void testGetCurrentPageRows() {
        ...
        coreContextCtrl.expectAndReturn(coreContext.loadUsersByPage(0, 1, User.USER_NAME_PROPERTY, true), page1); 
        coreContextCtrl.expectAndReturn(coreContext.loadUsersByPage(1, 1, User.USER_NAME_PROPERTY, true), page2); 
