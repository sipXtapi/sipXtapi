...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "src\cse" /I "..\sipXportLib\include" /I "..\sipXtackLib\include" /I "..\sipXcommserverLib\include" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D SIPX_CONFDIR=\".\" /D SIPX_LOGDIR=\".\" /D SIPX_VERSION=\"2.7\" /YX /FD /GZ /c
...
# ADD LINK32 sipXportLibd.lib sipXtackLibd.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib libpcre.a libeay32.lib ssleay32.lib sipXcommserverLibd.lib /nologo /subsystem:console /pdb:"Debug/sipXforkingProxy.pdb" /debug /machine:I386 /pdbtype:sept /libpath:"../sipXportLib/debug" /libpath:"../sipXtackLib/debug" /libpath:"../sipXcommserverLib/debug"
# SUBTRACT LINK32 /pdb:none
